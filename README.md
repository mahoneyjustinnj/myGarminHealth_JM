### Git Setup Instructions for Posit (RStudio)
...
⚠️ **Caution:** If your local folder has files that conflict with GitHub, Git may warn you or reject the pull.  
Make sure your local folder is clean or matches GitHub before pulling.
